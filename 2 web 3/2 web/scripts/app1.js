...
button.addEventListener('click', function(){
 ...
 let imageObject = document.querySelector('.cover-image img');
    let gallery = ['assets/26.jpg', 'assets/25.jfif','assets/24.jpg']
...
weather.open("GET", 'https://goweather.herokuapp.com/weather/Pripyat', true)
